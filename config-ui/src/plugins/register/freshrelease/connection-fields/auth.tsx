...
export const Auth = ({ type, initialValues, values, setValues, setErrors }: Props) => {
  ...
  return (
    <>
      <Block title="Freshrelease Version" required>
        <Radio.Group value={version} onChange={handleChangeVersion}>
          <Radio value="cloud">Freshrelease Cloud</Radio>
          <Radio value="server">Freshrelease Server</Radio>
        </Radio.Group>
        ...
        <Block
          ...
          description={
            <>
              {version === 'cloud'
                ? 'Provide the Freshrelease instance API endpoint. For Freshrelease Cloud, e.g. https://your-company.atlassian.net/rest/. Please note that the endpoint URL should end with /.'
                : ''}
              {version === 'server'
                ? 'Provide the Freshrelease instance API endpoint. For Freshrelease Server, e.g. https://freshrelease.your-company.com/rest/. Please note that the endpoint URL should end with /.'
                : ''}
            </>
          }
          required
