      ...
      <div className="radio">
        <div className="radio-item">
          ...
          <div className="content">
            <h5>Connect Freshrelease issues and commits via Freshrelease issues’ remote links that match the following pattern</h5>
            <Collapse
              ghost
        ...
        <div className="radio-item">
          ...
          <div className="content">
            <h5>
              Connect Freshrelease issues and commits via{' '}
              <ExternalLink link="https://support.atlassian.com/freshrelease-software-cloud/docs/view-development-information-for-an-issue/">
                development panel
              </ExternalLink>
            </h5>
            <p>Finish the configuration so DevLake can get your Git data from your Freshrelease development panel.</p>
            {radio === 'dev-panel' && (
              <>
