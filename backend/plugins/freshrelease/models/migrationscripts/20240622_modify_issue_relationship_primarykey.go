...
import (
	...
	freshreleaseArchived "github.com/apache/incubator-devlake/plugins/freshrelease/models/migrationscripts/archived"
)

type modifyIssueRelationship struct{}

type FreshreleaseIssueRelationship20240622 struct {
	archived.NoPKModel
...
func (FreshreleaseIssueRelationship20240622) TableName() string {
	return "_tool_freshrelease_issue_relationships"
}

func (script *modifyIssueRelationship) Up(basicRes context.BasicRes) errors.Error {
	err := basicRes.GetDal().DropTables(&freshreleaseArchived.FreshreleaseIssueRelationship{})
	if err != nil {
		return err
	}
	return migrationhelper.AutoMigrateTables(
		basicRes,
		&FreshreleaseIssueRelationship20240622{},
	)
}

func (*modifyIssueRelationship) Version() uint64 {
	return 20240622122537
}

func (*modifyIssueRelationship) Name() string {
	return "modify _tool_freshrelease_issue_relationships table primary key"
}
