...
type FreshreleaseIssueChangelogs struct {
	archived.NoPKModel
...
type FreshreleaseIssueChangelogItems struct {
	archived.NoPKModel
...
func (FreshreleaseIssueChangelogs) TableName() string {
	return "_tool_freshrelease_issue_changelogs"
}

func (FreshreleaseIssueChangelogItems) TableName() string {
	return "_tool_freshrelease_issue_changelog_items"
}
