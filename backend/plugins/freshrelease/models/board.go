...
var _ plugin.ToolLayerScope = (*FreshreleaseBoard)(nil)

type FreshreleaseBoard struct {
...
func (b FreshreleaseBoard) ScopeId() string {
	return fmt.Sprintf("%d", b.BoardId)
}

func (b FreshreleaseBoard) ScopeName() string {
	return b.Name
}

func (b FreshreleaseBoard) ScopeFullName() string {
	return b.Name
}

func (b FreshreleaseBoard) ScopeParams() interface{} {
	return &FreshreleaseApiParams{
		ConnectionId: b.ConnectionId,
		BoardId:      b.BoardId,
	}
}

func (FreshreleaseBoard) TableName() string {
	return "_tool_freshrelease_boards"
}

type FreshreleaseApiParams struct {
	ConnectionId uint64
	BoardId      uint64
}
