...
type FreshreleaseScopeConfig struct {
...
func (r *FreshreleaseScopeConfig) SetConnectionId(c *FreshreleaseScopeConfig, connectionId uint64) {
	c.ConnectionId = connectionId
	c.ScopeConfig.ConnectionId = connectionId
}

func (r *FreshreleaseScopeConfig) Validate() errors.Error {
	var err error
...
func (r FreshreleaseScopeConfig) TableName() string {
