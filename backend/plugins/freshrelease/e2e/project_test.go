...
func TestProjectDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_freshrelease_api_projects.csv", "_raw_freshrelease_api_projects")

	// verify issue extraction
	dataflowTester.FlushTabler(&models.FreshreleaseProject{})
	dataflowTester.Subtask(tasks.ExtractProjectsMeta, taskData)
	dataflowTester.VerifyTable(
		models.FreshreleaseProject{},
		"./snapshot_tables/_tool_freshrelease_projects.csv",
