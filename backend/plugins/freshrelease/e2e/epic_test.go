...
func TestEpicDataflow(t *testing.T) {
	...
	taskData := &tasks.FreshreleaseTaskData{
		Options: &tasks.FreshreleaseOptions{
			ConnectionId: 1,
			BoardId:      93,
			ScopeConfig:  &models.FreshreleaseScopeConfig{StoryPointField: "customfield_10024"},
		},
	}
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_freshrelease_external_epics.csv", "_raw_freshrelease_api_epics")
	...
	dataflowTester.VerifyTableWithOptions(
		models.FreshreleaseIssue{}, e2ehelper.TableOptions{
			CSVRelPath:   "./snapshot_tables/_tool_freshrelease_issues_for_external_epics.csv",
			TargetFields: nil,
			IgnoreFields: nil,
	...
	dataflowTester.VerifyTableWithOptions(
		models.FreshreleaseBoardIssue{}, e2ehelper.TableOptions{
			CSVRelPath:   "./snapshot_tables/_tool_freshrelease_board_issues_for_external_epics.csv",
