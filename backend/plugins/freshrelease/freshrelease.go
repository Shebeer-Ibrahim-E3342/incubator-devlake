...
var PluginEntry impl.Freshrelease //nolint

// standalone mode for debugging
func main() {
	cmd := &cobra.Command{Use: "freshrelease"}
	connectionId := cmd.Flags().Uint64P("connection", "c", 0, "freshrelease connection id")
	boardId := cmd.Flags().Uint64P("board", "b", 0, "freshrelease board id")
