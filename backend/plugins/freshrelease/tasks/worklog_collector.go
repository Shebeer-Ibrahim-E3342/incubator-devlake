...
const RAW_WORKLOGS_TABLE = "freshrelease_api_worklogs"

var CollectWorklogsMeta = plugin.SubTaskMeta{
	Name:             "collectWorklogs",
	EntryPoint:       CollectWorklogs,
	EnabledByDefault: true,
	Description:      "collect Freshrelease work logs, supports both timeFilter and diffSync.",
...
func CollectWorklogs(taskCtx plugin.SubTaskContext) errors.Error {
	...
	clauses := []dal.Clause{
		...
		dal.From("_tool_freshrelease_board_issues bi"),
		dal.Join("LEFT JOIN _tool_freshrelease_issues i ON (bi.connection_id = i.connection_id AND bi.issue_id = i.issue_id)"),
	...
	err = apiCollector.InitCollector(api.ApiCollectorArgs{
		...
		Query: func(reqData *api.RequestData) (url.Values, errors.Error) {
			...
			// https://community.atlassian.com/t5/Freshrelease-questions/Worklog-Pagination/qaq-p/117614
			// https://community.atlassian.com/t5/Freshrelease-questions/Worklog-Pagination-JIRA-REST-API/qaq-p/2173832
			return nil, nil
		},
