...
func NewFreshreleaseApiClient(taskCtx plugin.TaskContext, connection *models.FreshreleaseConnection) (*api.ApiAsyncClient, errors.Error) {
...
type FreshreleasePagination struct {
	StartAt    int `json:"startAt"`
	MaxResults int `json:"maxResults"`
	Total      int `json:"total"`
}

func GetFreshreleaseServerInfo(client *api.ApiAsyncClient) (*models.FreshreleaseServerInfo, int, errors.Error) {
	...
	serverInfo := &models.FreshreleaseServerInfo{}
