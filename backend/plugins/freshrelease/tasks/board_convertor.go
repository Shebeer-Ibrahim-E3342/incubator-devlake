...
const RAW_BOARD_TABLE = "freshrelease_api_boards"

var ConvertBoardMeta = plugin.SubTaskMeta{
	Name:             "convertBoard",
	EntryPoint:       ConvertBoard,
	EnabledByDefault: true,
	Description:      "convert Freshrelease board",
...
func ConvertBoard(taskCtx plugin.SubTaskContext) errors.Error {
	...
	idGen := didgen.NewDomainIdGenerator(&models.FreshreleaseBoard{})
	clauses := []dal.Clause{
		dal.Select("*"),
		dal.From(&models.FreshreleaseBoard{}),
	...
	converter, err := api.NewDataConverter(api.DataConverterArgs{
		...
		InputRowType: reflect.TypeOf(models.FreshreleaseBoard{}),
		Input:        cursor,
		Convert: func(inputRow interface{}) ([]interface{}, errors.Error) {
			board := inputRow.(*models.FreshreleaseBoard)
