...
func (c Comment) ToToolLayer(connectionId uint64, issueId uint64, issueUpdated *time.Time) *models.FreshreleaseIssueComment {
	result := &models.FreshreleaseIssueComment{
