...
func (i Issue) toToolLayer(connectionId uint64) *models.FreshreleaseIssue {
	var workload float64
	result := &models.FreshreleaseIssue{
...
func (i Issue) ExtractEntities(connectionId uint64) ([]uint64, *models.FreshreleaseIssue, []*models.FreshreleaseIssueComment, []*models.FreshreleaseWorklog, []*models.FreshreleaseIssueChangelogs, []*models.FreshreleaseIssueChangelogItems, []*models.FreshreleaseAccount) {
	issue := i.toToolLayer(connectionId)
	var comments []*models.FreshreleaseIssueComment
	var worklogs []*models.FreshreleaseWorklog
	var changelogs []*models.FreshreleaseIssueChangelogs
	var changelogItems []*models.FreshreleaseIssueChangelogItems
	var users []*models.FreshreleaseAccount
	var sprints []uint64
